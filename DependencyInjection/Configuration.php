...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('wow_apps_slack');
        $rootNode = method_exists(TreeBuilder::class, 'getRootNode') ? $treeBuilder->getRootNode() : $treeBuilder->root('wow_apps_slack');
        $rootNode
            ->children()
            ->scalarNode('api_url')
            ->isRequired()
